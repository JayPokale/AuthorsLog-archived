const Rightbar = () => {
  return (
    <aside className="w-80 px-4 py-2 fixed lg:static flex flex-col right-0">

      <div class="relative flex w-full rounded">
        <input type="search" class="relative w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out focus:text-gray-700 focus:bg-white focus:border-gray-600 focus:outline-none" placeholder="Search" aria-label="Search" aria-describedby="button-addon2" />
        <span class="flex items-center px-3 py-1.5 text-base font-normal text-gray-700 text-center whitespace-nowrap rounded cursor-pointer" id="basic-addon2">
      ...
      <div className="my-8 p-4 rounded-xl bg-gray-50 shadow-xl hidden lg:block">
